      ...
      <header className="border-b border-slate-700 p-4 bg-slate-800 shadow-xl">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          {(step !== 'setup' || slides.length > 0) && (
            <button 
              onClick={resetApp}
              className="text-sm text-slate-400 hover:text-white transition-colors bg-slate-700 px-3 py-1 rounded"
            >
              最初からやり直す
            </button>
          )}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700 shadow-lg h-full flex flex-col">
                  ...
                  <FileUploader onSlidesLoaded={setSlides} currentSlides={slides} />
